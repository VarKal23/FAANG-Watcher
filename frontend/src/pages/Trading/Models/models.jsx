...
function Models(props) {
    ...
    return (
        <div className="bg-white rounded-lg p-5 ml-6 min-w-[32%] max-w-[32%]"> {/* Adjusted width */}
            <div className="container mx-auto">
                <div className="flex flex-col space-y-4 items-center">
                    <div className="font-dm-sans font-semibold text-xl leading-5 flex items-center text-gray-500 mb-1">Generate Models</div>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full"> {/* Ensured full width */}
                        <button
                            className={`border-[3px] rounded-lg py-2 px-4 text-lg min-w-[120px] ${
                            selectedModel === 'Regression' ? 'border-blue-700' : 'bg-white'
                            }`}
                        ...
                        <button
                            className={`border-[3px] rounded-lg py-2 px-4 text-lg min-w-[120px] ${
                            selectedModel === 'ARIMA' ? 'border-blue-700' : 'bg-white'
                            }`}
                        ...
                        <button
                            className={`border-[3px] rounded-lg py-2 px-4 text-lg min-w-[120px] ${
                            selectedModel === 'LSTM' ? 'border-blue-700' : 'bg-white'
                            }`}
                        ...
                        <button
                            className={`border-[3px] rounded-lg py-2 px-4 text-lg min-w-[120px] ${
                            selectedModel === 'CNN' ? 'border-blue-700' : 'bg-white'
                            }`}
