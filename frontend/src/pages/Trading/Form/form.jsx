...
const form = (props) => {
  ...
  return (
    <div className="mr-6 min-w-[15%] max-w-[15%]">
      ...
      <select
        id="ticker"
        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        required
        value={title}
        onChange={event => setTitle(event.target.value)}
      >
        {/* Example ticker options */}
